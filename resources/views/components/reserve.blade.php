...
<form class="w-full max-w-lg">
  ...
  <div class="flex flex-wrap -mx-3 mb-2">
    ...
    <div class="w-full md:w-1/2 pl-3 mb-6 md:mb-0">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-attendants" type="text" placeholder="Leia Företagshotell">
      @error('grid-resource')
      <p class="text-red-500 text-xs italic">Please fill out this field.</p> 
      @enderror   
    </div>
